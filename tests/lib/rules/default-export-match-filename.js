...
ruleTester.run('lib/rules/filename', exportedRule, {
    valid: [
        {
            code: testCode,
            filename: '<text>',
    ...
    invalid: [
        {
            ...
            errors: [
                {
                    message:
                        "Filename 'fooBar' must match the exported name 'exported'.",
                    column: 1,
                    line: 1,
                },
            ],
        },
        {
            ...
            errors: [
                {
                    message:
                        "Filename 'foo' must match the exported name 'Foo'.",
                    column: 1,
                    line: 1,
                },
            ],
        ...
        },
        {
            ...
            errors: [
                {
                    message:
                        "Filename 'bar' must match the exported name 'foo'.",
                    column: 1,
                    line: 1,
                },
            ],
        ...
        // },
        {
            ...
            errors: [
                {
                    message:
                        "Filename 'Foo.react' must match the exported name 'Foo'.",
                    column: 1,
                    line: 1,
                },
            ],
...
ruleTester.run('lib/rules/filename with configuration', exportedRule, {
    valid: [
        {
    ...
    invalid: [
        ...
        },
        {
            ...
            errors: [
                {
                    message:
                        "Filename 'Foo.bar' must match the exported name 'Foo'.",
                    column: 1,
                    line: 1,
                },
            ],
