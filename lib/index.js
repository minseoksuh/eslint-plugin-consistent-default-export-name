...
module.exports = {
    ...
    rules: {
      "consistent-default-export-name/default-export-match-filename": defaultExportMatchFilename,
      "consistent-default-import-name/default-import-match-filename": defaultImportMatchFilename,
    },
};
